...
const navigation = [
  ...
  { name: 'Antrian Pasien', href: '/queue', icon: ClipboardList },
  ...
  { name: 'Resep', href: '/prescriptions/new', icon: Stethoscope },
  { name: 'Tagihan', href: '/billing', icon: DollarSign },
  { name: 'Inventori', href: '/inventory', icon: Package },
  { name: 'Laporan', href: '/reports/daily-revenue', icon: BarChart3 },
  { name: 'BPJS', href: '/bpjs/eligibility', icon: Shield },
];
